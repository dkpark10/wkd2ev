...
next app router로 서비스를 개편하면서 window history api를 조작하여 referer 값을 핸들링한 경험을 적어보고자 한다.
...
next app router는 window history api를 오버리이드 한다.
window history 는 브라우저의 세션 히스토리를 기록한다. window history를 오버라이드 하여 레퍼러 값을 다룰 수 있다.
...
다음 라우팅할 경로를 넝허준다. 이를 도식화하면 아래와 같다.

![pushState](/wkd2ev/images/pushstate.png)
...
![replaceState](/wkd2ev/images/replacestate.png)
...
<MdxImage src="/wkd2ev/images/referer_test1.png" width={468} height={238} alt="테스트 성공1" />
<MdxImage src="/wkd2ev/images/referer_test2.png" width={551} height={497} alt="테스트 성공2" />
